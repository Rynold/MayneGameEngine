...
namespace  MATH {
	...
	public:
		...
		static Matrix4 rotate(const Vec4 rot);
		static Matrix4 rotate(Matrix4 &mat, Vec4 rot);
		static Matrix4 translate(const float x_, const float y_, const float z_);
		static Matrix4 translate(const Vec3 vec);
		static Matrix4 translate(Matrix4 &mat, Vec3 vec);
		static Matrix4 scale(const float x_, const float y_, const float z_);
		static Matrix4 scale(const Vec3 scl);
		static Matrix4 scale(Matrix4 &mat, Vec3 scl);
